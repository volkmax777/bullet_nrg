...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Калькулятор энергии'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  final massEditController = TextEditingController();
  final velEditController = TextEditingController();
  ...
  void initState() {
    ...
    massEditController.addListener(_massEdit);
  }

  void _massEdit() {
    //_mass = numEditController.text;
  }
